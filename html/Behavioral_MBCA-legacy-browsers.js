...
function practice_timeoutLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  practice_timeout.forEach(function() {
...
function timeout_msg_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  timeout_msg_loop.forEach(function() {
...
function stim_presentation1RoutineBegin(trials) {
  return function () {
    ...
    stim_presentation1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function stim_presentation2RoutineBegin(trials) {
  return function () {
    ...
    stim_presentation2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function timeout_msgRoutineBegin(trials) {
  return function () {
    ...
    timeout_msgComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function long_delayRoutineBegin(trials) {
  return function () {
    ...
    long_delayComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function choice_b1RoutineBegin(trials) {
  return function () {
    ...
    choice_b1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function Outcome_expRoutineBegin(trials) {
  return function () {
    ...
    Outcome_expComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function counterfactual_expRoutineBegin(trials) {
  return function () {
    ...
    counterfactual_expComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
